...
Note: this may differ from how the pair is quoted in the market. Example: a GBP→USD hedge returns ≈ 0.79 (GBP per 1 USD), not the market's GBP/USD ≈ 1.27 (USD per 1 GBP).
