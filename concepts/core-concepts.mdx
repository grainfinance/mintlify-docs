...
## Conversion Transactions vs. Hedges

Grain offers two ways to exchange currencies:

- **Conversion** — an immediate currency conversion at the current market rate. Settlement typically occurs on the same day or within T\+2. Use spots when you need to convert funds now with no future rate risk.
